...
local name = tostring(name) or "Window"
...
local name = tostring(name) or "Tab"
local func = func or function() end
...
local name = tostring(name) or "Button"
local func = func or function() end
...
local name = tostring(name) or "Toggle"
...
local name = tostring(name) or "Slider"
...
local name = tostring(name) or "Dropdown"
local func = func or function() end
...
local name = tostring(name) or "TextBox"
