...
function ClosureEvn()
    ...
    function Library:Console()
        ...
        konsole_title.Text = "~ : catsus -- Konsole"
        ...
        overview = {
            command = {
                neofetch = function()
                    local default = 
    [[
                            <font color="rgb(255,125,0)">catsus@rubuntu</font>
                            <font color="rgb(255,125,0)">----------------------------------</font>
                            <font color="rgb(255,125,0)">Script</font>: Nothing UI
                            <font color="rgb(255,125,0)">Developers</font>: catsus
